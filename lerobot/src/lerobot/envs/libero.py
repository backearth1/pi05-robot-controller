...
class LiberoEnv(gym.Env):
    ...
    def render(self):
        if self.render_mode == "human":
            # Call underlying robosuite env's render method
    ...
    def _make_envs_task(self, task_suite: Any, task_id: int = 0):
        ...
        # Use ControlEnv with on-screen renderer for human mode
        if self.render_mode == "human":
            env_args["has_renderer"] = True
            env_args["has_offscreen_renderer"] = True  # Need both for camera obs + visualization
